...
public class FuncionarioService {
    ...
    public void inserir(Funcionario funcionario) {
        try {
            ...
            String cep = funcionario.getCep().replaceAll("[^0-9]", ""); // Remove caracteres não numéricos do CEP
            if (cep.length() != 8) {
                throw new Exception("CEP inválido! Deve conter exatamente 8 dígitos numéricos.");
            }
            funcionario.setCep(cep); // Atualiza o CEP no objeto Paciente com o valor formatado
